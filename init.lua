...
vim.keymap.set("n", "<leader>p", function()
	...
	if entry and entry.type == "file" and entry.name:match("%.png|.jpg|.webp") then
		vim.cmd("split " .. entry.name)
	end
end, { desc = "Preview image file" })
...
vim.api.nvim_create_autocmd("FileType", {
	pattern = "wiki",
	callback = function()
		-- Example: Disable normal mode mapping for <leader>e
